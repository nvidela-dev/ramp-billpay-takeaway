// Vendor domain: payees that bills are issued against, plus the bank/check
// methods used to pay them. Mirrors the `vendors` and
// `vendor_payment_methods` tables in the database schema.
